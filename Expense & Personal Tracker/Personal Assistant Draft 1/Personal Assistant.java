    ...
    fileET.delete();
     while(PARun){
            ...
            if(sql.login==true){
                ...
                switch(PAchoice){
                    ...
                    boolean EXrun = true;
                        ...
                        while (EXrun) {
                                ExpenseTracker ETM=new ExpenseTracker(USER, PASSWORD);
                                ...
                                int choice = sc.nextInt();
                                    ...
                                    switch (choice) {
                                        case 1:
                                            ...
                                            ETM.addExpense(category, amount);
                                            break;
                                            ...
                                            while(update){
                                                ...
                                                switch(choiceUpdate){
                                                    case 1:
                                                        ...
                                                        ETM.updateExpenses(amountUpdate, id);
                                                        break;
                                                    case 2:
                                                        System.out.println("Enter id");
                                                        id=sc.nextInt();
                                                        ...
                                                        ETM.updateExpenses(categoryUpdate, id);
                                                        break;
                                                    case 3:
                                                ...
                                                while(delete){
                                                    ...
                                                    switch(choiceDel){
                                                        ...
                                                        case 2:
                                                            ...
                                                            ETM.deleteExpenses(startDate, endDate);
                                                            break;
                                                        case 3:
                                                            ...
                                                            System.out.println("Enter ID:");
                                                            id =sc.nextInt();
                                                            ETM.deleteExpenses(categoryDelete, id);
                                                            break;
                                                        case 4:
                                                            System.out.println("Enter your Category:");
                                                            categoryDelete=sc.nextLine();
                                                            ETM.deleteExpenses(categoryDelete);
                                                            break;
                                                        case 5:
                        ...
                        case 2:
                            EventTracker ET = new EventTracker( USER, PASSWORD); 
            ...
            else
            {
                ...
                if(tries==0){
                    System.out.println("You have entered wrong password too many times, restart the application to try again");
                    sc.close();
                    PARun=false;
